...
const items = [
	...
	{
		title: '大于等于 0, 小于等于 150, 支持小数位出现 5, 如 145.5, 用于判断考卷分数',
	...
	{
		title: '银行卡号（10 到 30 位, 覆盖对公/私账户, 参考[微信支付](https://pay.weixin.qq.com/wiki/doc/api/xiaowei.php?chapter=22_1)）',
		rule: /^[1-9]\d{9,29}$/,
	...
	{
		title: '手机号（mobile phone）中国（严谨）, 根据工信部 2019 年最新公布的手机号段',
		rule: /^(?:(?:\+|00)86)?1(?:(?:3[\d])|(?:4[5-79])|(?:5[0-35-9])|(?:6[5-7])|(?:7[0-8])|(?:8[\d])|(?:9[189]))\d{8}$/,
		examples: ['008618311006933', '+8617888829981', '19119255642']
	},
	{
		title: '手机号（mobile phone）中国（宽松）, 只要是 13,14,15,16,17,18,19 开头即可',
		rule: /^(?:(?:\+|00)86)?1[3-9]\d{9}$/,
		examples: ['008618311006933', '+8617888829981', '19119255642']
	},
	{
		title: '手机号（mobile phone）中国（最宽松）, 只要是 1 开头即可, 如果你的手机号是用来接收短信, 优先建议选择这一条',
		rule: /^(?:(?:\+|00)86)?1\d{10}$/,
		examples: ['008618311006933', '+8617888829981', '19119255642']
	},
	{
	...
	{
		title: '密码强度校验，最少 6 位，包括至少1个大写字母，1 个小写字母，1 个数字，1 个特殊字符',
